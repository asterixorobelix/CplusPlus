...
void getInput(int& housePrice, int& downPayment);

void calculate(int price, downPay);

int main(){

	int price, downPay;

	getInput(price, downPay);

	std::cout<<"housePrice: "<<price<<std::endl;
	
	calculate(int price, downPay);
...
void getInput(int& housePrice, int& downPayment){
	...
	std::cout<<"Enter the house price: \n";

	std::cin>>housePrice;

	std::cout<<"Enter the downPayment: \n";
	std::cin>>downPayment;
}

void calculate(int price, downPay){

	constexpr float mortgage {0.03}, interest {0.06}, taxRate {0.35};
	............
	}
*/
